...
function EPdoctor() {
  ...
  useEffect(()=>{
    axios.get(_apiurldoctor+"fetch?email="+fetchemail).then((result)=>{
     setName(result.data[0].name);
     setEmail(result.data[0].email);
     setExperience(result.data[0].experience);
  ...
  const handleSubmit=(()=>{
  let updatedoctor= {"condition_obj":{"email":email},"content_obj":{"name":name,"experience":experience,"specialization":specialization,"designation":designation,"personalmobile":personalmobile,"clinicmobile":clinicmobile,"clinicaddress":clinicaddress,"residentialaddress":residentialaddress,"contactdescription":contactdescription}}
  axios.patch(_apiurldoctor+"update",updatedoctor).then((Response)=>{
                ...
                <div class="row g-0">
                  ...
                  <div class="col-xl-6">
                    <div class="card-body p-md-5 text-black">
                      <h3 class="mb-5 text-uppercase">Doctors Edit Profile Form</h3>
                      ...
                      <div class="form-outline mb-4">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Type address here ..." value={contactdescription} onChange={e => setContactDescription(e.target.value)} ></textarea>
